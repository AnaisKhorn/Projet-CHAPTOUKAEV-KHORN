class CasLight {
  ...
  constructor(_id: string,  id_cas: string,  cas_nom_dossier: string,  cas_zone_nom: string, cas_classification: string, cas_AAAA: string, cas_temoignages_nb: string, cas_resume_web: string, cas_date_maj: string) {
    this._id = _id;
    this.id_cas = id_cas;
